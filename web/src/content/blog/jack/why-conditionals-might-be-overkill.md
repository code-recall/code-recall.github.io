---
title: 'Why conditionals might be overkill'
description: 'Examining when utilities like clsx are necessary for conditional styling and how to simplify React components with TailwindCSS pseudo-class modifiers.'
pubDate: '2024-10-21'
author: 'Jack Morris'
tags:
  - TypeScript
...
<Modal
  className={({ isEntering, isExiting }) =>
    classNames('tw-w-full tw-max-w-md tw-overflow-hidden tw-rounded-2xl tw-p-6 tw-text-left tw-align-middle', {
